...
export default function Rocket() {
  ...
  this.rocketTween = gsap.set(this.rocket.position, { x: 0 })
...
Rocket.prototype.flyPath = function () {
  ...
  this.tweenPosition = gsap.to(rocket1.rocket.position, 0.1, { x: pt.x, y: pt.y, z: pt.z })
  this.tweenQuaternion = gsap.to(this.rocket.quaternion, 0.1, {
    x: quaterions._x,
    y: quaterions._y,
    z: quaterions._z
  })
